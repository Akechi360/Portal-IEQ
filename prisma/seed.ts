...
async function main() {
  ...
  // 4. DATOS DE DEMO (Médicos y Credenciales)
  ...
  const staffUser1 = await prisma.staffUser.upsert({
    where: { email: "gerencia@ieq.med" },
    update: {},
    create: {
  ...
  console.log(`  ✔ Staff → ${staffUser1.nombre} (${staffUser1.email})`);
  ...
  console.log("─────────────────────────────────────────────");
  console.log("  Staff Institucional:");
  console.log("  Gerencia  → gerencia@ieq.med");
  console.log("─────────────────────────────────────────────\n");
}
