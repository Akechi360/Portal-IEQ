...
export default function AdminLoginPage() {
  ...
  const leftFeatures: Array<{ icon: "shield" | "zap" | "clock" | "infinity" | "users"; bold: string; text: string }> = [
    { icon: "shield", bold: "Acceso restringido", text: "solo departamento de Sistemas" },
    { icon: "users", bold: "Gestión completa", text: "usuarios, red y configuración" },
    { icon: "zap", bold: "Panel en tiempo real", text: "monitoreo 24/7 de la red" },
  ];
  ...
  return (
    <LoginLayout
      leftColor="#0F172A"
      leftTitle="Panel de\nControl IEQ"
      leftDescription="Acceso exclusivo para el departamento de Sistemas. Solo personal autorizado."
      leftFeatures={leftFeatures}
      badgeSSID="Admin · Sistemas"
      badgePrefix=""
      badgeTheme="slate"
    >
      <div className="max-w-sm w-full mx-auto">
        <h2 className="text-2xl font-bold text-gray-900">Iniciar sesión</h2>
        <p className="text-sm text-gray-500 mt-1 mb-8">Ingresa tus credenciales de administrador</p>
        ...
        <div className="mt-8 w-full flex items-center justify-center gap-2 bg-slate-50 border border-slate-200 rounded-xl py-2.5 px-4">
          ...
          <span className="text-xs text-slate-500">
            <span className="font-semibold text-slate-700">Panel de Control · Sistemas</span>
          </span>
        </div>
      </div>
    </LoginLayout>
