    ...
    <div className="flex flex-col space-y-6">
      ...
      <div className="flex flex-col gap-8 md:flex-row">
        ...
        <div className="flex flex-1 flex-col">
          ...
          {activeTab === "Base de datos" && <DatabaseTab />}
          
          {/* Placeholders para las siguientes pestañas */}
          {activeTab !== "General" && activeTab !== "Red WiFi" && activeTab !== "Autenticación" && activeTab !== "Notificaciones" && activeTab !== "Administradores" && activeTab !== "Base de datos" && (
